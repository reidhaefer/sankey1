setwd("X:/Trans/STAFF/Reid/Various")
library(pacman)
pacman::p_load (riverplot,googleVis,plotly,shiny,googleVis,rjson,rCharts,bitops,RCurl,Rcpp,devtools,grid,dplyr,stringr,ggplot2,ggthemes,scales,plyr,base64enc,RColorBrewer)
